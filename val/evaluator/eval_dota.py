...
import os
from DOTA_val_eval import dota_main

class eval_dota(object):
    ...
    def test_in_training(self, model):
        ...
        for iter_id, batches in enumerate(self.dataloader):
            ...
            img_name = batches['img_name'][0].split('.png')[0]
        ...
        return dota_main(dst_dir, gt_path=self.cfg.data.gt_path,
